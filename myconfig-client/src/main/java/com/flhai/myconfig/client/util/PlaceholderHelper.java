package com.flhai.myconfig.client.util;
...
public class PlaceholderHelper {
     ...
     * </ul>
     */
    public Set<String> extractPlaceholderKeys(String propertyValue) {
        Set<String> placeholderKeys = new LinkedHashSet<>();

        if (!isNormalizedPlaceholder(propertyValue) && !isExpressionWithPlaceholder(propertyValue)) {
